...
//		};
		...
		Arithemetic lam_sum = (double a, double b) -> a+b;

		Arithemetic lam_sub = (double a, double b) -> a-b;

		Arithemetic lam_mul = (double a, double b) -> a*b;

		Arithemetic lam_div = (double a, double b) -> a/b;
